...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  saveZip: (data, defaultPath) => ipcRenderer.invoke("save-zip-file", data, defaultPath),
  readFile: (filePath) => ipcRenderer.invoke("read-file", filePath),
  importMultipleProjects: () => ipcRenderer.invoke("load-multiple-projects"),
  onOpenFilePath: (callback) => ipcRenderer.on("open-file-path", (_event, path) => callback(path)),
