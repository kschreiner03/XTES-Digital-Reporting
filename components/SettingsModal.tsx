...
const SettingsModal: React.FC<SettingsModalProps> = ({ onClose }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-lg shadow-2xl w-full max-w-3xl h-[600px] flex flex-col overflow-hidden">
                <div className="flex justify-between items-center p-4 border-b bg-gray-50">
                    <h2 className="text-2xl font-bold text-gray-800">Settings</h2>
                    <button onClick={onClose} className="text-gray-500 hover:text-gray-800 transition-colors" aria-label="Close settings">
                    ...
                    <div className="w-1/4 bg-gray-100 border-r border-gray-200 p-4">
                        <nav className="space-y-2">
                            <button
                                ...
                                className={`w-full text-left px-4 py-2 rounded-md font-medium transition-colors ${activeTab === 'general' ? 'bg-[#007D8C] text-white' : 'text-gray-600 hover:bg-gray-200'}`}
                            >
                                General
                            </button>
                             <button
                                onClick={() => setActiveTab('data')}
                                className={`w-full text-left px-4 py-2 rounded-md font-medium transition-colors ${activeTab === 'data' ? 'bg-[#007D8C] text-white' : 'text-gray-600 hover:bg-gray-200'}`}
                            >
                                Data Management
                            </button>
                        </nav>
                    ...
                    <div className="w-3/4 p-8 overflow-y-auto">
                        {activeTab === 'general' && (
                            <div className="space-y-6">
                                <div>
                                    <h3 className="text-xl font-bold text-gray-800 mb-4 border-b pb-2">Default Values</h3>
                                    ...
                                    <div className="space-y-4">
                                        <div>
                                            <label className="block text-sm font-bold text-gray-700 mb-1">Default Proponent</label>
                                            <input 
                                                type="text" 
                                                value={defaults.defaultProponent}
                                                onChange={(e) => handleDefaultChange('defaultProponent', e.target.value)}
                                                className="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-[#007D8C] focus:border-[#007D8C] transition"
                                                placeholder="e.g., Cenovus, CNRL"
                                            />
                                            <p className="text-xs text-gray-500 mt-1">Used in Photo Logs and Standard DFRs.</p>
                                        </div>
                                        
                                        <div>
                                            <label className="block text-sm font-bold text-gray-700 mb-1">Default Monitor Name</label>
                                            <input 
                                                type="text" 
                                            ...
                                            />
                                             <p className="text-xs text-gray-500 mt-1">Used in DFRs.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        {activeTab === 'data' && (
                            <div className="space-y-6">
                                <div>
                                    <h3 className="text-xl font-bold text-gray-800 mb-4 border-b pb-2">Storage & Data</h3>
                                ...
                                <div className="border-t pt-6">
                                    ...
                                    <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                                        <h5 className="font-bold text-red-800 mb-1">Clear All Local Data</h5>
